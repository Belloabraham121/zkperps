...
export function PositionsPanelBox() {
  return (
    <section className="flex min-h-[180px] shrink-0 flex-col border-t border-neutral-700 bg-neutral-900/50 p-3">
      <div className="mb-2 flex items-center justify-between">
        <span className="text-sm font-medium text-rose-200/90">
          [Positions / Order History]
        </span>
        <span className="text-xs text-rose-400/70">
          Positions · Open Orders · History · P&L · Trades
        </span>
      </div>
